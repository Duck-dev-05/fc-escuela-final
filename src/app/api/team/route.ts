...
const OFFICIAL_ROSTER = [
  ...
  { 
    id: 2, name: 'Lê Vũ Nhật Minh', role: 'CB', image: null, bio: 'Prestigious Defense Specialist. Unyielding flagship buffer.', order: 2, captain: false, status: 'available', 
  ...
  { 
    id: 4, name: 'Nguyễn Đức Bảo Phong', role: 'CB', image: null, bio: 'Flagship Defensive Node. Elite intercept specialist.', order: 4, captain: false, status: 'available', 
    physical: { height: '184cm', weight: '77kg', age: 20, dob: '08/11/2005', foot: 'Right' },
    stats: { appearances: 18, goals: 0, tackles: 32, minutes: 1620 },
    contract: { joined: 'Octobre 2023', expires: '2028' }
  },
  { 
    id: 5, name: 'Vũ Nhật Ninh', role: 'RB', image: null, bio: 'Tactical Flank Controller. Sustainable elite endurance.', order: 5, captain: false, status: 'available', 
    physical: { height: '178cm', weight: '72kg', age: 19, dob: '14/01/2007', foot: 'Right' },
    stats: { appearances: 21, goals: 0, assists: 4, minutes: 1890 },
    contract: { joined: 'Octobre 2023', expires: '2027' }
  },
  { 
    id: 6, name: 'Phạm Công Toàn', role: 'LB', image: null, bio: 'Core Sector Anchor. Strategic flank mastery.', order: 6, captain: false, status: 'available', 
  ...
  { 
    id: 8, name: 'Đỗ Quốc Khánh', role: 'AMF', image: null, bio: 'Operational Creative Hub. Elite playstyle designer.', order: 8, captain: false, status: 'available', 
  ...
  { 
    id: 10, name: 'Nguyễn Quang Minh Thành', role: 'CF', image: null, bio: 'Vector Impact Unit. Precision scoring mastery.', order: 10, captain: false, status: 'available', 
    physical: { height: '186cm', weight: '79kg', age: 20, dob: '11/08/2005', foot: 'Right' },
    stats: { appearances: 22, goals: 15, assists: 4, minutes: 1760 },
    contract: { joined: 'Octobre 2023', expires: '2028' }
  },
  { 
    id: 11, name: 'Đặng Minh Việt', role: 'RW', image: null, bio: 'Prestigious Strike Operative. Direct impact mastery.', order: 11, captain: false, status: 'available', 
