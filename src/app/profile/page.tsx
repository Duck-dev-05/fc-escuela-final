            ...
            <div className="glass-card p-8 md:p-10 flex flex-col md:flex-row items-center md:items-start gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                <div className="flex items-center justify-center md:justify-start gap-2 mb-3">
                  ...
                  {profile?.roles === 'admin' && (
                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-[10px] font-bold uppercase tracking-wider text-amber-400">
                      Admin
                    </span>
                  )}
                </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-center md:justify-start gap-4 text-sm text-slate-500">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold text-slate-400">{profile?.roles === 'admin' ? 'Head Coach' : 'Member'}</span>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="glass-card p-8 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                          <h3 className="text-[11px] font-bold text-slate-600 uppercase tracking-widest mb-4">Tactical Philosophy</h3>
                          ...
                          <div className="grid grid-cols-3 gap-6 pt-6 border-t border-white/8 text-sm">
                            {[
                              ...
                              { label: 'Focus',  value: 'Verticality' },
                            ].map(item => (
                              <div key={item.label}>
                                <span className="block text-slate-600 font-medium mb-1 text-xs">{item.label}</span>
                      ...
                      <div className="glass-card p-8">
                        <div className="flex items-center justify-between mb-6">
                          <h3 className="text-[11px] font-bold text-slate-600 uppercase tracking-widest">Recent Honors</h3>
                          <span className="text-sm font-bold text-amber-400">4 Titles</span>
                        </div>
