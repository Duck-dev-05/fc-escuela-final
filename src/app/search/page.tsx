...
const pages = [
  ...
  { name: "Orders", href: "/profile/orders", description: "Check your ticket and merchandise orders." },
  { name: "Settings", href: "/profile", description: "Manage your account settings and preferences." },
