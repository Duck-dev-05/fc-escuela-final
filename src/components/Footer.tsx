      ...
      <div className="max-w-[1600px] mx-auto relative z-20 px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 mb-14">
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="flex flex-col gap-8">
              <Link href="/" className="flex items-center gap-4 group w-fit">
                <div className="relative w-14 h-14 rounded-2xl overflow-hidden border border-white/10 bg-white/5 p-1.5 transition-all duration-500 group-hover:border-amber-500/40 group-hover:shadow-[0_0_24px_rgba(245,158,11,0.2)]">
                  <Image
                    src="/images/logo.jpg"
                    alt="FC ESCUELA"
                    width={56}
                ...
                <div className="flex flex-col gap-0.5">
                  <h2 className="text-xl font-black tracking-tighter text-white leading-none uppercase group-hover:text-amber-400 transition-colors duration-500">
                    ESCUELA
                  </h2>
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex-1 h-px min-w-[30px] bg-white/10 group-hover:bg-amber-500/40 transition-all duration-700" />
                  </div>
                </div>
              </Link>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-[11px] font-bold text-slate-500 uppercase tracking-widest hover:text-amber-400 transition-all flex items-center gap-3 group/item"
                    >
                      <div className="w-1 h-1 rounded-full bg-white/20 group-hover/item:bg-amber-500 transition-colors" />
                      {link.label}
                    </Link>
                  </li>
                ))}
          ...
          <div className="lg:col-span-3 space-y-8 flex flex-col items-start lg:items-end lg:pt-4">
              ...
              <div className="flex items-center lg:justify-end gap-3">
                {[
                  ...
                  <a
                    ...
                    className="w-10 h-10 flex items-center justify-center rounded-xl bg-white/5 border border-white/10 text-slate-500 hover:text-amber-400 hover:border-amber-500/30 hover:bg-amber-500/5 transition-all duration-300"
                  >
            ...
            {/* Membership CTA */}
            <div className="w-full rounded-2xl border border-amber-500/20 bg-amber-500/5 p-5 lg:text-right">
              <p className="text-[10px] font-bold uppercase tracking-wider text-amber-500 mb-2">Elite Access</p>
              <p className="text-xs text-slate-400 mb-4">Unlock premium features and club benefits.</p>
              <Link
                href="/profile/membership"
                className="inline-flex items-center gap-2 rounded-xl bg-amber-500 px-4 py-2 text-[11px] font-bold uppercase tracking-wider text-slate-950 transition hover:bg-amber-400"
              >
                View Plans
              </Link>
            </div>
